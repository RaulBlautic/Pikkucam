...
public class DriveServiceHelper {
    ...
    public static String TYPE_VIDEO = "video/mp4";
    ...
    /**
     * Creates a video file in the user's My Drive folder and returns its file ID.
     */
    public Task<String> createFile(java.io.File video) {
        return Tasks.call(mExecutor, () -> {
            File metadata = new File()
                    .setParents(Collections.singletonList("root/Pikkucam"))
