...
public class Camera2ViewFragment extends Fragment {
    ...
    public static Camera2ViewFragment newInstance() {
        return new Camera2ViewFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_camera2_view, container, false);
    }
    ...
    private void openCamera(int width, int height) {
        ...
        try {
            ...
            for (String cameraId : manager.getCameraIdList()) {
                ...
                // We don't use a back camera in this code
            ...
            Toast.makeText(act, "Cannot access the camera.", Toast.LENGTH_SHORT).show();
            act.finish();
    ...
    private void configureTransform(int viewWidth, int viewHeight) {
        if (null == mTextureView || null == mPreviewSize || null == act) {
            return;
        }
